		...
		<div class="htmleaf-links">
			<a class="htmleaf-icon icon-htmleaf-home-outline"
				title= target="_blank"><span>
					</span></a> <a class="htmleaf-icon icon-htmleaf-arrow-forward-outline"
				
				title= target="_blank"><span> </span></a>
		</div>
		</header>
		<p class="center"></p>
		<p class="center"></p>
			...
			<div id="login_form" class="form">
				<form class="register-form" name="register">
					<input type="text" placeholder="用户名" id="r_user_name" /> <input
						type="password" placeholder="密码" id="r_password" />
						 <input type="email" placeholder="电子邮件" id="r_emial" />
					<button id="create">创建账户</button>
					<p class="message">
						已经有了一个账户? <a href="#login">立刻登录</a>
					</p>
				</form>
